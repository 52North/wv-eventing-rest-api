 ...
 */
@JsonPropertyOrder({"id", "href", "label", "description", "details", "seriesHref", "notifications"})
public class WvPublication implements Publication {
    ...
    private List<TemplateDefinition> notifications;
    ...
    public List<TemplateDefinition> getNotifications() {
        return notifications;
    }

    public void setNotifications(List<TemplateDefinition> notifications) {
