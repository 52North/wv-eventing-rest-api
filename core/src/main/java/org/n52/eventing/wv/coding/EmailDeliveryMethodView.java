...
import org.n52.eventing.wv.services.EmailDeliveryProviderImpl;

/**
 *
 * @author <a href="mailto:m.rieke@52north.org">Matthes Rieke</a>
 */
public class EmailDeliveryMethodView implements DeliveryMethodDefinition {

    private String href;

    public EmailDeliveryMethodView() {
    }

    @JsonView(value = {Views.SubscriptionExpanded.class, Views.TemplateOverview.class})
    @Override
    public String getId() {
        return EmailDeliveryProviderImpl.IDENTIFIER;
    }
