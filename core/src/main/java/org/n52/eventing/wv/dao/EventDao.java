...
public interface EventDao extends BaseDao<WvEvent> {
    ...
    QueryResult<WvEvent> retrieveForSubscription(int... idInt);

    QueryResult<WvEvent> retrieveForSubscription(Pagination page, int... idInt);

    QueryResult<WvEvent> retrieveWithFilter(Map<String, String[]> filter, Pagination page);
