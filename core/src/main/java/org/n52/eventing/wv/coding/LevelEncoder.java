...
import org.n52.eventing.wv.view.LevelView;

/**
 *
 * @author <a href="mailto:m.rieke@52north.org">Matthes Rieke</a>
 */
public class LevelEncoder extends ModelEncoder<NotificationLevel, LevelView> {

    @Override
    public LevelView encode(NotificationLevel model) throws IllegalStateException {
        if (model == null) {
