 ...
 */
public class HibernateNotificationLevelDao extends BaseHibernateDao<NotificationLevel> implements NotificationLevelDao {

    public HibernateNotificationLevelDao(Session session) {
        super(session);
    }
