...
public class WvTemplatesDaoFactory implements TemplatesDaoFactory {
    ...
    public TemplatesDao newDao() {
        ...
        if (params.containsKey("expanded")) {
            expanded = Boolean.parseBoolean(params.get("expanded")[0]);
        }
        return new TemplatesServiceImpl(i18n, hdc, context, expanded, accessRights, userSecurityService, pageFactory);
    }
