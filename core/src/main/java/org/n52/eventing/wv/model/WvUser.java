...
public class WvUser implements BaseEntity, Serializable {
    ...
    private static final long serialVersionUID = -6816149959414278622L;
    private int id;
    private long userid;
    private String name;
    ...
    public Set<Group> getAdminGroups() {
        return getGroups().stream().filter(g -> g.isGroupAdmin()).collect(Collectors.toSet());
    }

    public boolean hasAdminGroups() {
        return getAdminGroups() != null && !getAdminGroups().isEmpty();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof WvUser)) {
            return false;
        }
