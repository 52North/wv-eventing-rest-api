...
import org.n52.eventing.wv.view.UnitView;

/**
 *
 * @author <a href="mailto:m.rieke@52north.org">Matthes Rieke</a>
 */
public class UnitEncoder extends ModelEncoder<Unit, UnitView> {

    @Override
    public UnitView encode(Unit model) throws IllegalStateException {
        if (model == null) {
        ...
        result.setUnitCode(model.getCode());
