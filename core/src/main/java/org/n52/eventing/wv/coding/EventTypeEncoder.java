 ...
 */
public class EventTypeEncoder extends ModelEncoder<WvEventType, EventTypeView> {

    @Override
    public EventTypeView encode(WvEventType model) throws IllegalStateException {
        if (model == null) {
            throw new IllegalStateException("source cannot be null");
        }

        EventTypeView result = new EventTypeView();
