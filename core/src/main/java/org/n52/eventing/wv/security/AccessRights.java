...
public interface AccessRights {
    ...
    boolean isGroupAdmin(WvUser u, int id);

    boolean canCreateNotifications(WvUser user);

    boolean withinAdminGroupNames(String name);

    WvUser enhanceUser(WvUser wvUser);
