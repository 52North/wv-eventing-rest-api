...
import org.n52.eventing.wv.view.CategoryView;

/**
 *
 * @author <a href="mailto:m.rieke@52north.org">Matthes Rieke</a>
 */
public class CategoryEncoder extends ModelEncoder<Category, CategoryView> {

    @Override
    public CategoryView encode(Category model) throws IllegalStateException {
        if (model == null) {
        ...
        result.setCategoryId(model.getCategoryId());
